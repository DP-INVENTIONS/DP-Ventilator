...
#define maxBPM                     30     // maximum respiratory speed
...
#define motorSpeed               6400     // Speed for 1 liter/second
#define motorAcceleration       45000     // Acceleration for 1 liter / second (inverse square of flow)
#define motorMaxAcceleration    45000     // deceleration when pressure limit reached
#define motorMinAcceleration      100     // minimum acceleration to prevent stalling / very slow moves
#define motorMaxSpeed            8000     // Max steps per second. 
...
/*+++ NEXTION dvdh +++*/
#define motorMicrosteps         16 // 1/16
#define motorVolumeRatio        0.15*motorMicrosteps // Ratio of distance in steps to air volume in step per milliliter.
...
/*+++ NEXTION dvdh +++*/
#define NxtDisplay          // Use a Nextion 4.3" Touchscreen 
